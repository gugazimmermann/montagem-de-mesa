...
export const modalAjudaExemplos =
  'mt-3 grid grid-cols-2 gap-3 max-[480px]:grid-cols-1'

export const modalAjudaExemplo =
  'flex flex-col gap-1.5 rounded-md border border-border bg-surface p-2.5'

export const modalAjudaExemploTitulo =
  'm-0 text-xs font-semibold text-text'

export const modalAjudaExemploDesc =
  'm-0 text-xs leading-snug text-muted'

export const modalAjudaExemploPreview =
  'flex aspect-square items-center justify-center overflow-hidden rounded border border-dashed border-border bg-[repeating-conic-gradient(#e8ebe9_0%_25%,#fff_0%_50%)_0_0/12px_12px] [&_img]:max-h-full [&_img]:max-w-full [&_img]:object-contain'

export const modalAjudaRodape =
  'flex shrink-0 justify-end border-t border-border px-4 py-3'
...
export const historicoNota =
  'mt-3 grid gap-2 rounded-md border border-border bg-surface-solid px-3 py-2.5'

export const historicoNotaCabecalho =
  'flex flex-wrap items-baseline justify-between gap-x-2 gap-y-0.5'

export const historicoNotaTitulo =
  'm-0 text-[0.7rem] font-medium tracking-[0.03em] text-muted uppercase'

export const historicoNotaDica = 'm-0 text-[0.7rem] text-muted'

export const historicoNotaTextarea =
  `${fieldInput} box-border min-h-[5.5rem] w-full resize-y leading-relaxed`

export const historicoNotaRodape =
  'flex flex-wrap items-center justify-between gap-2'

export const historicoNotaContador = 'm-0 text-[0.7rem] tabular-nums text-muted'

export const historicoNotaPreview =
  'mt-1.5 mb-0 line-clamp-2 border-l-2 border-border pl-2 text-[0.8125rem] leading-snug text-muted'
